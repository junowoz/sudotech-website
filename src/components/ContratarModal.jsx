...
const maintenancePlan = {
  name: "Plano de Premium Mensal (3 Sessões)",
  price: "R$199/Mês",
  description: "Garanta que seu site esteja sempre atualizado e otimizado.",
  features: [
    "Manutenção e Suporte técnico",
    "Atualização de conteúdo",
    "Relatório mensal do Google Analytics",
    "Google Analytics.",
    "SEO Avançado - Otimização avançada do seu site, incluindo pesquisa de palavras-chave, otimização de conteúdo e construção de links para melhorar sua visibilidade nos motores de busca",
  ],
};

export const ContratarModal = ({ setIsOpen }) => (
  <AnimatePresence>
    <motion.div
